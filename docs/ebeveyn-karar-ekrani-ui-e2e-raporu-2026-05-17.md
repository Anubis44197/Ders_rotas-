...
- Kanit klasoru: [e2e-artifacts-2026-05-17-stabilization](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization)
- Ham JSON: [ui-e2e-result.json](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/ui-e2e-result.json)
- Kosu logu: [ui-e2e.log](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/ui-e2e.log)
- Vite logu: [vite.log](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/vite.log)
...
- gercek sonuc: Karar sinyal sayisi: 3, workspace: hazir
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx
- screenshot/log: [01-main-signals.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/01-main-signals.png)
- ham JSON sonucu:
```json
{
  "id": 1,
...
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx
- screenshot/log: [02-course-detail-flow.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/02-course-detail-flow.png)
- ham JSON sonucu:
```json
{
  "id": 2,
...
- screenshot/log: [03-time-filters.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/03-time-filters.png)
- ham JSON sonucu:
```json
{
  "id": 3,
...
- gercek sonuc: Root overflow: -15, kart sayisi: 2
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx
- screenshot/log: [04-long-name-overflow.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/04-long-name-overflow.png)
- ham JSON sonucu:
```json
{
  "id": 4,
...
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx, App.tsx
- screenshot/log: [05-empty-state.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/05-empty-state.png), [05-low-state.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/05-low-state.png)
- ham JSON sonucu:
```json
{
  "id": 5,
...
- screenshot/log: [06-error-guard.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/06-error-guard.png)
- ham JSON sonucu:
```json
{
  "id": 6,
...
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx
- screenshot/log: [07-goal-panel.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/07-goal-panel.png)
- ham JSON sonucu:
```json
{
  "id": 7,
...
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx
- screenshot/log: [08-exam-cards.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/08-exam-cards.png)
- ham JSON sonucu:
```json
{
  "id": 8,
...
- gercek sonuc: etiketler=Stabil
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx
- screenshot/log: [09-alert-levels.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/09-alert-levels.png)
- ham JSON sonucu:
```json
{
  "id": 9,
...
- kullanilan veri: `qaRecords=manual, analysisTab=insights, e2e=1`
- kullanilan selector/test-id: `[data-testid="create-revision-task-btn"]`, `[data-testid="switch-child-mode-btn"]`, `[data-plan-task-id^="parent-action-"]`
...
- screenshot/log: [10-parent-to-child-task.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/10-parent-to-child-task.png)
- ham JSON sonucu:
```json
{
  "id": 10,
...
- screenshot/log: [11-child-complete-parent.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/11-child-complete-parent.png)
- ham JSON sonucu:
```json
{
  "id": 11,
...
- kullanilan veri: `qaRecords=manual, create-revision iki kez, e2e=1`
- kullanilan selector/test-id: `[data-testid="create-revision-task-btn"]`, `task.planTaskId^="parent-action-"`
- beklenen sonuc: Ayni parent aksiyonu duplicate gorev olusturmamali.
- gercek sonuc: pending 0->1 (delta=1), total=1, unique=1, duplicate=0
- PASS/FAIL: `PASS`
- ilgili dosya: components/parent/ParentAnalysisWorkspace.tsx, App.tsx
- screenshot/log: [13-idempotency.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/13-idempotency.png)
- ham JSON sonucu:
```json
{
  "id": 13,
...
- PASS/FAIL: `PASS`
- screenshot/log: [e1-no-e2e-quick-complete.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/e1-no-e2e-quick-complete.png)
- ham JSON sonucu:
```json
{
  "id": "E1",
  ...
  "pass": true,
  "evidence": [
    "C:\\Users\\90535\\Desktop\\Ders_rotas-\\docs\\e2e-artifacts-2026-05-17-stabilization\\e1-no-e2e-quick-complete.png"
  ]
}
```
...
- PASS/FAIL: `PASS`
- screenshot/log: [e2-no-e2e-seed.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/e2-no-e2e-seed.png)
- ham JSON sonucu:
```json
{
  "id": "E2",
  ...
  "pass": true,
  "evidence": [
    "C:\\Users\\90535\\Desktop\\Ders_rotas-\\docs\\e2e-artifacts-2026-05-17-stabilization\\e2-no-e2e-seed.png"
  ]
}
```
...
- PASS/FAIL: `PASS`
- screenshot/log: [e3-no-e2e-parent-child.png](C:/Users/90535/Desktop/Ders_rotas-/docs/e2e-artifacts-2026-05-17-stabilization/e3-no-e2e-parent-child.png)
- ham JSON sonucu:
```json
{
  "id": "E3",
  ...
  "pass": true,
  "evidence": [
    "C:\\Users\\90535\\Desktop\\Ders_rotas-\\docs\\e2e-artifacts-2026-05-17-stabilization\\e3-no-e2e-parent-child.png"
  ]
}
```
